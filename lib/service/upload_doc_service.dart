...
import 'package:finch/model/upload_doc_model.dart';
...
Future<UploadDocResultModel> uploadDocumentToServer(String docPath) async {
  ...
  try {
    ...
    Reference ref =
        FirebaseStorage.instance.ref().child('loan').child('/$docName.pdf');
    ...
    return Future.value(UploadDocResultModel(
        state: ViewState.Error, fileUrl: '"F-Error uploading image"'));
  } catch (error) {
